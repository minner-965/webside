...
> = {
  ...
  fr: {
    ...
    heroTitle: 'Une boutique lifestyle plus claire, plus simple et plus facile a offrir.',
    heroBody:
      'Decouvrez des pieces apparel, gadgets de bureau, mini jouets, objets maison et idees cadeaux dans une boutique plus lisible avec paiement securise et politiques claires.',
    heroPrimary: 'Voir la selection',
    heroSecondary: 'Lire les standards',
